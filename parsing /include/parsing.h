...
/*   Updated: 2025/04/19 00:22:16 by sel-mlil         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# ifndef TEST
// #  define TEST "''"
#  define TEST "( ls '$cat' > \"dawd\"'saad'\"\"\"\"'''''''''''''''' -e | \"$grep\" \"$txt\" > \"text_files\" ) && ( cat < Makefile-e) && echo \"Text files found:\"&& cat text_files.list|| (echo \"$No text files found\" >> error.log && exit 1) | wc -l < input.txt >> results.log"
# endif
